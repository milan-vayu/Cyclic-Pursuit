% N agents randomly left in 3D space
% If they follow each other at pi/n angle, they finally converge to a circular trajectory

%each page contains coordinates of each agent at different times
n=input('number of agents');             % take n as input
al=pi/n;                                 %initial offset
...
for t=1:1:100000
    for i=1:n
        u(1:3,i)=(k*T*(z(1:3,mod(i,n)+1)-z(1:3,i)));
    end
    for i=1:n
