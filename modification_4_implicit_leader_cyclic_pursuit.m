...
% {implicit leader cyclic pursuit with modified phi taking input as number of agents ,initial coordinates of agents, position of target and initial heading angle of each agent assuming each agent moves with same and constant speed}%

% {depends only on bearing angle measurements}%
